...
I'm a Software Engineer, currently undergoing my MSc in Big Data Technologies at [Glasgow Caledonian University](http://gcu.ac.uk/). I'm passionate about web development, AI/ML, anime, batman, Chelsea FC and video/mobile games.

**Here's a quick summary about me**:

- 😊 Pronouns: He/him
- 🌱 I’m currently learning how to build AI/ML models.
- 🎧 I’m open to opportunities in open source projects, hackathons, SAAS, e-commerce companies and startups.
- 💼 Job interests: Frontend/Fullstack Engineer, Web Developer, Data Engineer.
- 🛠 Tech stack: React JS/TS, NextJS/TS, HTML, CSS, SCSS, JavaScript, TypeScript, Node, Express, MongoDB, GraphQL, MySQL, PHP, Python, Kubernetes, Docker, Azure, AWS, GCP
